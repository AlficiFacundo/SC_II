...
%%
clc; clear; close all;
data = readmatrix('Curvas_Medidas_Motor_2025_v.xlsx');
t = data(:,1);
w = data(:,2);
ia = data(:,3);
Va = data(:,4);
...
%%
%Caso 2: Implementar el mismo sistema controlador del ítem anterior, empleando los valores del
% motor siguiente. Ir variando entre cambio y no cambio.
%Ra=2.27;
%La=0.0047;
%Ki=0.25;
%Km=0.25;
